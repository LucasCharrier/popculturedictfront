            ...
            <div class="field has-addons">
                <p class="control">
                    <a
                        ...
                        <span>{{definition.tags.reduce((a,t) => a + t.id, 0) + definition.user.id + (definition.text.length > 100 ? (100 - definition.word.name.length) : definition.text.length) + definition.like }}</span>
                    </a>
                </p>
                <p class="control">
                    <a
                        ...
                        <span>{{definition.tags.reduce((a,t) => a + t.id, 0) + definition.user.id + (definition.text.length > 50 ? (50 + definition.word.name.length) : definition.text.length) + definition.dislike}}</span>
                    </a>
                </p>
            </div>
        </div>
